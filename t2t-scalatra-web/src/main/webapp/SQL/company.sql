...
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(1,'价格是多少','789','估计有120元吧','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(2,'后台管理功能','789','估计有120元吧','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(3,'查看留言和回复留言','789','估计有120元吧','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(4,'最终效果是什么样的','789','估计有120元吧','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(5,'有户名和密码错误','789','估计有120元吧','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(6,'估计有120元吧','789','估计有120元吧','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(7,'楼上的你知道不','789','估计有120元吧','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(8,'还行吧','789','估计有120元吧','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(9,'估计有120元吧','789','估计有120元吧','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(10,'5月1日','789','5月1日','2000-12-12',1);
insert into TBL_REVERT(revertID,title,name,content,replyDate,messageID)values(11,'不知道','789','不知道','2000-12-12',1);
