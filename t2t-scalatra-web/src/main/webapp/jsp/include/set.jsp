...
%>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/js/plugins/datatable/css/jquery.dataTables.css">
...
<link href="<%=request.getContextPath()%>/theme/top.css" rel="stylesheet"/>
...
<!-- DataTables -->
<script src="<%=request.getContextPath()%>/js/plugins/datatable/js/jquery.dataTables.min.js"></script>
...
<script type="text/javascript" language="javascript" src="<%=request.getContextPath()%>/js/datagrid.js"></script>
